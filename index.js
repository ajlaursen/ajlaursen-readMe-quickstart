    ...
    inquirer.prompt([
        {
          ...
          },
          {
            ...
            choices: ["MIT License", "Apache License 2.0", "GNU General Public License (GPL)", "GNU Library or \"Lesser\" General Public License (LGPL)", "Mozilla Public License 2.0", "Common Development and Distribution License", "Eclipse Public License version 2.0", "BSD 3-Clause \"New\" or \"Revised\" license", "BSD 2-Clause \"Simplified\" or \"FreeBSD\" license"]
          },
          {
            type: 'number',
            name: 'contributors',
      ...
      for (x = 1; x <= answers.contributors; x++){
        ...
        .then((answers) => {
          ...
          for (y = 1; y <= userArrayLength; y++){
            ...
            contributorOutput = contributorOutput.concat(`[${contrib}](https://github.com/${user})  `)
          }
